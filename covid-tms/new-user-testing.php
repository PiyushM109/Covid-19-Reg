...
<form name="newtesting" method="post">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-secondary">Enter Personal Details Here </h6>
                                </div>
                                <div class="card-body">
                        <div class="form-group">
                            <label >Enter your full name</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Full name" pattern="[A-Za-z ]+" title="letters only" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Enter your mobile Number here</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                               <label>Name of the Government Id</label>
                                        ...
                                        <div class="form-group">
                                              <label>Enter Unique Identification number of selected ID</label>
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="ID Number"pattern="[0-9]{10}" title="12 numeric characters only" required="true">
                                        </div>
 ...
 <div class="form-group">
                       ...
                       <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" id="submit" style="background-color:gray; color:white">                           
                             </div>
